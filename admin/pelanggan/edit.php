...
if ($_GET['id']) {
    $kode = $_GET['id'];
    $data = $koneksi->query("SELECT * FROM pelanggan where kode_pelanggan = '$kode'")->fetch_array();
} else {
    header("location: ../pelanggan", true, 301);
}
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-900">Edit Data Pelanggan</h1>
                                ...
                                <div class="card shadow mb-4">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input autocomplete="off" type="text" class="form-control" name="kode_pelanggan" id="kode_pelanggan" value="<?= $kode; ?>" required readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="nama_pelanggan" id="nama_pelanggan" value="<?= $data['nama_pelanggan'] ?>" required autofocus>
                                            </div>
                                        </div>
