...
if ($_GET['id']) {
    $kode = $_GET['id'];
    $data = $koneksi->query("SELECT * FROM supplier where kode_supplier = '$kode'")->fetch_array();
} else {
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-900">Edit Data Supplier</h1>
                                ...
                                <div class="card shadow mb-4">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input autocomplete="off" type="text" class="form-control" name="kode_supplier" id="kode_supplier" value="<?= $kode; ?>" required readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="nama_supplier" id="nama_supplier" value="<?= $data['nama_supplier'] ?>" required autofocus>
                                            </div>
                                        </div>
