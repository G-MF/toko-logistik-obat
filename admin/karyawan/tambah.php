...
$query1 = $koneksi->query("SELECT max(kode_karyawan) AS kode FROM karyawan");
...
$kodeotomatis = "K" . sprintf('%03s', $nourut);
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-900">Tambah Data Karyawan</h1>
                                ...
                                <div class="card shadow mb-4">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input autocomplete="off" type="text" class="form-control" name="kode_karyawan" id="kode_karyawan" value="<?= $kodeotomatis; ?>" required readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="nama_karyawan" id="nama_karyawan" required autofocus>
                                            </div>
                                        </div>
