...
if ($_GET['id']) {
    $kode = $_GET['id'];
    $data = $koneksi->query("SELECT * FROM stok_obat where kode_obat = '$kode'")->fetch_array();
} else {
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-900">Edit Data Stok Obat</h1>
                                ...
                                <div class="card shadow mb-4">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input autocomplete="off" type="text" class="form-control" name="kode_obat" id="kode_obat" value="<?= $data['kode_obat']; ?>" required readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="nama_obat" id="nama_obat" required autofocus value="<?= $data['nama_obat'] ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control rupiah" name="harga_jual" id="harga_jual" required value="<?= $data['harga_jual'] ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="jenis_obat" id="jenis_obat" required value="<?= $data['jenis_obat'] ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="file" class="form-control" name="gambar_obat" id="gambar_obat">
                                                <span style="font-style: italic; color: red; font-size: 10px;">
                                                    *(JPG, JPEG, PNG) <br>
                                                    *isi jika ingin merubah gambar
                                                </span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="number" class="form-control" name="jumlah_stok" id="jumlah_stok" required value="<?= $data['jumlah_stok'] ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="dosis_obat" id="dosis_obat" required value="<?= $data['dosis_obat'] ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea class="form-control" name="ket_obat" id="ket_obat" rows="3" required><?= $data['ket_obat'] ?></textarea>
                                            </div>
                                        </div>
